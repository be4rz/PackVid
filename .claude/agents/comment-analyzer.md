...
description: Meticulous code comment analyzer for technical documentation quality. Verifies accuracy, completeness, and long-term value. Use when reviewing documentation and comments.
model: inherit
---
