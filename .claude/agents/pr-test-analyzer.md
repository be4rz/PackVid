...
description: Expert test coverage analyst for PR review. Ensures adequate test coverage for critical functionality without being pedantic. Use when reviewing PRs for test coverage.
model: inherit
---
