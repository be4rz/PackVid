...
description: Type design expert for analyzing and improving type designs. Evaluates invariants, encapsulation, and type safety. Use when reviewing TypeScript types or designing data models.
model: inherit
---
